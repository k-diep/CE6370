	soc_system u0 (
		...
		.pio_inputfromfpga_external_connection_export (<connected-to-pio_inputfromfpga_external_connection_export>), // pio_inputfromfpga_external_connection.export
		.pio_nn_input_external_connection_in_port     (<connected-to-pio_nn_input_external_connection_in_port>),     //      pio_nn_input_external_connection.in_port
		.pio_nn_input_external_connection_out_port    (<connected-to-pio_nn_input_external_connection_out_port>),    //                                      .out_port
		.reset_reset_n                                (<connected-to-reset_reset_n>),                                //                                 reset.reset_n
		.pio_outputfromhps_external_connection_export (<connected-to-pio_outputfromhps_external_connection_export>)  // pio_outputfromhps_external_connection.export
	);
