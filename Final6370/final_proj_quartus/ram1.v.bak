...
//altmem_init CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" INIT_FILE="soc_system/syn/myproject_softmax_stable_ap_fixed_ap_fixed_16_6_5_3_0_softmax_config10_s_exp_table_ROM_bkb.mif" INIT_TO_ZERO="NO" NUMWORDS=1024 PORT_ROM_DATA_READY="PORT_UNUSED" ROM_READ_LATENCY=1 WIDTH=18 WIDTHAD=10 clock dataout init init_busy ram_address ram_wren
...
module  ram1_meminit_tnv
	...
	defparam
		int_rom.init_file = "soc_system/syn/myproject_softmax_stable_ap_fixed_ap_fixed_16_6_5_3_0_softmax_config10_s_exp_table_ROM_bkb.mif",
...
module ram1 (
	...
	ram1_meminit_tnv	ram1_meminit_tnv_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
