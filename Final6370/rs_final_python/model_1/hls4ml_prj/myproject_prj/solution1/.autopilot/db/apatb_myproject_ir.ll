; ModuleID = 'C:/Users/Tim/PycharmProjects/rs_final/model_1/hls4ml_prj/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_myproject_ir(%"struct.ap_uint<1>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="400" %input0, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="10" "partition" %layer10_out) local_unnamed_addr #0 {
entry:
  %input0_copy3 = alloca i400, align 512
  ...
  %0 = bitcast %"struct.ap_uint<1>"* %input0 to [400 x %"struct.ap_uint<1>"]*
  %1 = bitcast %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %layer10_out to [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*
  call void @copy_in([400 x %"struct.ap_uint<1>"]* nonnull %0, i400* nonnull align 512 %input0_copy3, [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %1, i16* nonnull align 512 %layer10_out_copy_0, i16* nonnull align 512 %layer10_out_copy_1, i16* nonnull align 512 %layer10_out_copy_2, i16* nonnull align 512 %layer10_out_copy_3, i16* nonnull align 512 %layer10_out_copy_4, i16* nonnull align 512 %layer10_out_copy_5, i16* nonnull align 512 %layer10_out_copy_6, i16* nonnull align 512 %layer10_out_copy_7, i16* nonnull align 512 %layer10_out_copy_8, i16* nonnull align 512 %layer10_out_copy_9)
  call void @apatb_myproject_hw(i400* %input0_copy3, i16* %layer10_out_copy_0, i16* %layer10_out_copy_1, i16* %layer10_out_copy_2, i16* %layer10_out_copy_3, i16* %layer10_out_copy_4, i16* %layer10_out_copy_5, i16* %layer10_out_copy_6, i16* %layer10_out_copy_7, i16* %layer10_out_copy_8, i16* %layer10_out_copy_9)
  call void @copy_back([400 x %"struct.ap_uint<1>"]* %0, i400* %input0_copy3, [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %1, i16* %layer10_out_copy_0, i16* %layer10_out_copy_1, i16* %layer10_out_copy_2, i16* %layer10_out_copy_3, i16* %layer10_out_copy_4, i16* %layer10_out_copy_5, i16* %layer10_out_copy_6, i16* %layer10_out_copy_7, i16* %layer10_out_copy_8, i16* %layer10_out_copy_9)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a10struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.103"([10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %src_3, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.4" %src_4, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.5" %src_5, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.6" %src_6, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.7" %src_7, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.8" %src_8, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.9" %src_9) #3 {
entry:
  %0 = icmp eq [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a10struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.106"([10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i16* %src_0, i16* %src_1, i16* %src_2, i16* %src_3, i16* %src_4, i16* %src_5, i16* %src_6, i16* %src_7, i16* %src_8, i16* %src_9, i64 10)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a400struct.ap_uint<1>.116"(i400* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [400 x %"struct.ap_uint<1>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
  %0 = icmp eq [400 x %"struct.ap_uint<1>"]* %src, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [400 x %"struct.ap_uint<1>"], [400 x %"struct.ap_uint<1>"]* %src, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %1 = add i64 %dst_shift, %for.loop.idx2
  %2 = bitcast i1* %src.addr.0.0.05 to i8*
  %3 = load i8, i8* %2
  %4 = trunc i8 %3 to i1
  %5 = load i400, i400* %dst, align 64
  %6 = zext i64 %1 to i400
  %7 = shl i400 1, %6
  %8 = zext i1 %4 to i400
  %9 = shl i400 %8, %6
  %thr.xor1 = xor i400 %7, -1
  %thr.and2 = and i400 %5, %thr.xor1
  %thr.or3 = or i400 %thr.and2, %9
  store i400 %thr.or3, i400* %dst, align 64
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a400struct.ap_uint<1>.113"(i400* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [400 x %"struct.ap_uint<1>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #3 {
entry:
  %0 = icmp eq [400 x %"struct.ap_uint<1>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a400struct.ap_uint<1>.116"(i400* %dst, i64 0, [400 x %"struct.ap_uint<1>"]* nonnull %src, i64 400)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a400struct.ap_uint<1>"([400 x %"struct.ap_uint<1>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i400* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
  %0 = icmp eq [400 x %"struct.ap_uint<1>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %dst.addr.0.0.06 = getelementptr [400 x %"struct.ap_uint<1>"], [400 x %"struct.ap_uint<1>"]* %dst, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %2 = load i400, i400* %src, align 64
  %3 = zext i64 %1 to i400
  %4 = lshr i400 %2, %3
  %5 = trunc i400 %4 to i1
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a400struct.ap_uint<1>"([400 x %"struct.ap_uint<1>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i400* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #3 {
entry:
  %0 = icmp eq [400 x %"struct.ap_uint<1>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a400struct.ap_uint<1>"([400 x %"struct.ap_uint<1>"]* nonnull %dst, i400* %src, i64 0, i64 400)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([400 x %"struct.ap_uint<1>"]* noalias "orig.arg.no"="0" "unpacked"="0", i400* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0", [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="2" "unpacked"="2", i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_0, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_1, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_2, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_3, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.4" %_4, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.5" %_5, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.6" %_6, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.7" %_7, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.8" %_8, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.9" %_9) #5 {
entry:
  call void @"onebyonecpy_hls.p0a400struct.ap_uint<1>"([400 x %"struct.ap_uint<1>"]* %0, i400* align 512 %1)
  call void @"onebyonecpy_hls.p0a10struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.103"([10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2, i16* align 512 %_3, i16* align 512 %_4, i16* align 512 %_5, i16* align 512 %_6, i16* align 512 %_7, i16* align 512 %_8, i16* align 512 %_9)
  ret void
}

declare void @apatb_myproject_hw(i400*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_back([400 x %"struct.ap_uint<1>"]* noalias "orig.arg.no"="0" "unpacked"="0", i400* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0", [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="2" "unpacked"="2", i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_0, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_1, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_2, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_3, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.4" %_4, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.5" %_5, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.6" %_6, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.7" %_7, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.8" %_8, i16* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.9" %_9) #5 {
entry:
  call void @"onebyonecpy_hls.p0a10struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.103"([10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2, i16* align 512 %_3, i16* align 512 %_4, i16* align 512 %_5, i16* align 512 %_6, i16* align 512 %_7, i16* align 512 %_8, i16* align 512 %_9)
  ret void
}

define void @myproject_hw_stub_wrapper(i400*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*) #6 {
entry:
  %11 = alloca [400 x %"struct.ap_uint<1>"]
  %12 = alloca [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]
  call void @copy_out([400 x %"struct.ap_uint<1>"]* %11, i400* %0, [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %12, i16* %1, i16* %2, i16* %3, i16* %4, i16* %5, i16* %6, i16* %7, i16* %8, i16* %9, i16* %10)
  %13 = bitcast [400 x %"struct.ap_uint<1>"]* %11 to %"struct.ap_uint<1>"*
  %14 = bitcast [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %12 to %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"*
  call void @myproject_hw_stub(%"struct.ap_uint<1>"* %13, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %14)
  call void @copy_in([400 x %"struct.ap_uint<1>"]* %11, i400* %0, [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %12, i16* %1, i16* %2, i16* %3, i16* %4, i16* %5, i16* %6, i16* %7, i16* %8, i16* %9, i16* %10)
  ret void
}

declare void @myproject_hw_stub(%"struct.ap_uint<1>"*, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"*)
