; ModuleID = 'C:/Users/Tim/PycharmProjects/rs_final/model_3/hls4ml_prj/model_3/hls4ml_prj/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_myproject_ir(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="400" %input_9, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="10" "partition" %layer10_out) local_unnamed_addr #0 {
entry:
  %input_9_copy3 = alloca i6400, align 512
  ...
  %0 = bitcast %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %input_9 to [400 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*
  %1 = bitcast %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %layer10_out to [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*
  call void @copy_in([400 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %0, i6400* nonnull align 512 %input_9_copy3, [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %1, i16* nonnull align 512 %layer10_out_copy_0, i16* nonnull align 512 %layer10_out_copy_1, i16* nonnull align 512 %layer10_out_copy_2, i16* nonnull align 512 %layer10_out_copy_3, i16* nonnull align 512 %layer10_out_copy_4, i16* nonnull align 512 %layer10_out_copy_5, i16* nonnull align 512 %layer10_out_copy_6, i16* nonnull align 512 %layer10_out_copy_7, i16* nonnull align 512 %layer10_out_copy_8, i16* nonnull align 512 %layer10_out_copy_9)
  call void @apatb_myproject_hw(i6400* %input_9_copy3, i16* %layer10_out_copy_0, i16* %layer10_out_copy_1, i16* %layer10_out_copy_2, i16* %layer10_out_copy_3, i16* %layer10_out_copy_4, i16* %layer10_out_copy_5, i16* %layer10_out_copy_6, i16* %layer10_out_copy_7, i16* %layer10_out_copy_8, i16* %layer10_out_copy_9)
  call void @copy_back([400 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %0, i6400* %input_9_copy3, [10 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %1, i16* %layer10_out_copy_0, i16* %layer10_out_copy_1, i16* %layer10_out_copy_2, i16* %layer10_out_copy_3, i16* %layer10_out_copy_4, i16* %layer10_out_copy_5, i16* %layer10_out_copy_6, i16* %layer10_out_copy_7, i16* %layer10_out_copy_8, i16* %layer10_out_copy_9)
  ret void
}
