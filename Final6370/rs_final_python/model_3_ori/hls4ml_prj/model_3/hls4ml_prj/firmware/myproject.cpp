...
void myproject(
    input_t input_9[N_INPUT_1_1],
    result_t layer10_out[N_LAYER_8]
) {

    // hls-fpga-machine-learning insert IO
    #pragma HLS ARRAY_RESHAPE variable=input_9 complete dim=0
    #pragma HLS ARRAY_PARTITION variable=layer10_out complete dim=0
    #pragma HLS INTERFACE ap_vld port=input_9,layer10_out 
    #pragma HLS PIPELINE 
    ...
    nnet::dense<input_t, layer2_t, config2>(input_9, layer2_out, w2, b2); // fc1
